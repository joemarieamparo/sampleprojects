package com.mindandinnovation.chatapp.widgets;
 ...
 * <p>
 * The older version of ChatMessageView. The latest has a bug. - Jome
 */

public class AppChatMessageView extends RelativeLayout {
    ...
    public AppChatMessageView(Context context) {
        super(context);
        initialize(null, 0);
    }

    public AppChatMessageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(attrs, 0);
    }

    public AppChatMessageView(Context context, AttributeSet attrs, int defStyleAttr) {
